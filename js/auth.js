...
// Export functions if needed elsewhere (though not strictly necessary if only used via event listeners)
// export { handleLogin, handleRegistration, handleLogout, checkAuthState };
